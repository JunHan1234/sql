-- table 삭제 : auto commit :dml -- ddl: 수동 commit
drop table hire_dates;

-- table 생성 : auto commit
...
insert into hire_dates(emp_id) values(3); /*쓰지 않은 hire_date column은 설정했던 default값이 들어간다.*/
...
-- system에 접속 후 아래 입력. /system2.sql로 저장.
/*
